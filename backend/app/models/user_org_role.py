...
class UserOrgRole(Base):
    ...
    org_id:  Mapped[int] = mapped_column(ForeignKey("organizations.id"), primary_key=True, nullable=False)

    role:    Mapped[str] = mapped_column(String(50), nullable=False)

    # relationships (os nomes precisam casar com back_populates nas outras classes)
